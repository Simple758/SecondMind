package com.secondmind.minimal.dev.ui
...
import com.secondmind.minimal.dev.AppGroup

@Composable
fun AppInboxScreen(
    groups: List<AppGroup>,
    onReadApp: (AppGroup) -> Unit,
    ...
    LazyColumn(
        ...
        items(groups.size) { i ->
            val g = groups[i]
            Card(
                modifier = Modifier.fillMaxWidth().clickable { onOpenApp(g.pkg) }
            ) {
                Row(
